    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{route('intents.nlu_store')}}" method="POST">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="question" type="text" class="form-control @error('name') is-invalid @enderror" name="question" value="{{ old('name') }}" required autocomplete="question" autofocus>
